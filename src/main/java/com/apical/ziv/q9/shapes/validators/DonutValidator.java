 ...
 */
@Component
public class DonutValidator implements Validatable {

	@Override
	public void validate(String[] words) throws ValidateException {
		if (words.length < ShapeConsts.COMMAND_LINE_WORDS_COUNT_DONUT) {
			throw new ValidateException(ErrorConsts.ERROR_001);
		} else if (words.length > ShapeConsts.COMMAND_LINE_WORDS_COUNT_DONUT) {
