...
public class DistanceUtil {
	...
	public static boolean interset(Rectangle rect, Circle circle) {
		...
		if (circle.inside(x + width, y)) {
			return true;
		}
		if (circle.inside(x + width, y + height)) {
			return true;
		}
		if (circle.inside(x, y + height)) {
			return true;
		}
		return false;
	}
	...
	public static boolean interset(Triangle tri, Rectangle rect) {
		...
		if (tri.inside(rx1, ry1)) {
			return true;
		}
		if (tri.inside(rx1 + weight, ry1)) {
			return true;
		}
		if (tri.inside(rx1 + weight, ry1 + height)) {
			return true;
		}
		if (tri.inside(rx1, ry1 + height)) {
			return true;
		}

		if (rect.inside(tx1, ty1)) {
			return true;
		}
		if (rect.inside(tx2, ty2)) {
			return true;
		}
		if (rect.inside(tx3, ty3)) {
			return true;
		}

		if (Line2D.linesIntersect(tx1, ty1, tx2, ty2, rx1, ry1, rx1 + weight, ry1)) {
			return true;
		}
		if (Line2D.linesIntersect(tx1, ty1, tx2, ty2, rx1 + weight, ry1, rx1 + weight, ry1 + height)) {
			return true;
		}
		if (Line2D.linesIntersect(tx1, ty1, tx2, ty2, rx1 + weight, ry1 + height, rx1, ry1 + height)) {
			return true;
		}
		if (Line2D.linesIntersect(tx1, ty1, tx2, ty2, rx1, ry1 + height, rx1, ry1)) {
			return true;
		}

		if (Line2D.linesIntersect(tx2, ty2, tx3, ty3, rx1, ry1, rx1 + weight, ry1)) {
			return true;
		}
		if (Line2D.linesIntersect(tx2, ty2, tx3, ty3, rx1 + weight, ry1, rx1 + weight, ry1 + height)) {
			return true;
		}
		if (Line2D.linesIntersect(tx2, ty2, tx3, ty3, rx1 + weight, ry1 + height, rx1, ry1 + height)) {
			return true;
		}
		if (Line2D.linesIntersect(tx2, ty2, tx3, ty3, rx1, ry1 + height, rx1, ry1)) {
			return true;
		}

		if (Line2D.linesIntersect(tx3, ty3, tx1, ty1, rx1, ry1, rx1 + weight, ry1)) {
			return true;
		}
		if (Line2D.linesIntersect(tx3, ty3, tx1, ty1, rx1 + weight, ry1, rx1 + weight, ry1 + height)) {
			return true;
		}
		if (Line2D.linesIntersect(tx3, ty3, tx1, ty1, rx1 + weight, ry1 + height, rx1, ry1 + height)) {
			return true;
		}
		if (Line2D.linesIntersect(tx3, ty3, tx1, ty1, rx1, ry1 + height, rx1, ry1)) {
			return true;
		}
